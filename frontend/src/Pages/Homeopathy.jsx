...
const Homeopathy = () => {
  ...
  const [sortrange, setsortrange] = useState(
    searchParams.getAll("sortrange") || []
  );
  const [products, setProducts] = useState([]);
  const [brandrange, setbrandrange] = useState(
    searchParams.getAll("brandrange") || []
  );
  ...
  }, [categoryTag, sortingByPrice, sortrange, brandrange, page]);
  ...
  useEffect(() => {
    axios
      .get(
        `https://onemg-w2kv.onrender.com/products/${category}?page=${page}`,
        {
          params: searchParams,
        }
      )
    ...
    <div>
      ...
      <Container maxW={"100%"} minH={"100vh"} bgColor={"#f6f6f6"}>
        {isLargerThan1024 ? null : (
          <Box>
            <Box>
              <Button variant="filled" onClick={onOpenDrawer1}>
                <Icon
              ...
              <Box>
                ...
                >
                  ...
                  <DrawerContent height={"30em"}>
                    ...
                    <DrawerFooter>
                      <Button
                        onClick={onCloseDrawer1}
                        bgColor={"#ff6f61"}
                        color={"black"}
                      >
                        <Text fontSize={".8em"}>Apply Changes</Text>
                      </Button>
                    </DrawerFooter>
                  </DrawerContent>
                </Drawer>
                              ...
                              <RadioGroup onChange={setValue} value={value}>
                                <Stack direction="column">
                                  <Radio
                                    ...
                                    value="hightolow"
                                    color="#ff6f61"
                                    defaultChecked={order === "hightolow"}
                                  >
                                    High to Low
                                  </Radio>
                                  <Radio
                                    ...
                                    value="lowtohigh"
                                    color="#ff6f61"
                                    defaultChecked={order === "lowtohigh"}
                                  >
                                    Low to High
                                  </Radio>
                                  <Radio
                      ...
                      <HStack>
                        ...
                        <Box>
                          ...
                          >
                            ...
                            <DrawerContent height={"30em"}>
                              <DrawerCloseButton />
                              <DrawerHeader fontSize={"1.5em"} color="black">
                                Filter
                              </DrawerHeader>
                              <Divider
                                      ...
                                      {filterCategories.map((items, index) => (
                                        <Box key={index}>
                                          <Text
                                            ...
                                            color="black"
                                            onClick={() =>
                                              setFilterCategorie(items.value)
                                            }
                                          >
                                            {items.item}
                                          </Text>
        ...
        <Box>
          <Flex>
            {isLargerThan1024 ? (
              <Box
                maxW={"15%"}
                ml={["50px", "50px", "50px", "0px", "50px"]}
                mr={["50px", "50px", "50px", "50px", "50px"]}
                mt="10"
              >
                <Box
                  style={{ "box-shadow": " rgba(0, 0, 0, 0.16) 0px 1px 4px" }}
                  width={["400px", "400px", "100%", "150%", "150%"]}
                  p="5"
                  bgColor={"white"}
                >
                  <Text fontSize={"md"} fontWeight={"bold"} color={"#ff6f61"}>
                    FILTERS
                  </Text>
                          ...
                          <VStack alignItems={"left"}>
                            <Box>
                              ...
                              <RadioGroup>
                                <Stack direction="column">
                                  <Radio
                                    onChange={(e) =>
                                      setSortingByPrice(e.target.value)
                                    }
                                    value="desc"
                                    color="#ff6f61"
                                    isChecked={sortingByPrice === "desc"}
                                  >
                                    <Text fontSize={".8em"}>High to Low</Text>
                                  </Radio>
                                  <Radio
                                    onChange={(e) =>
                                      setSortingByPrice(e.target.value)
                                    ...
                                    value="asc"
                                    color="#ff6f61"
                                    isChecked={sortingByPrice === "asc"}
                                  >
                                    <Text fontSize={".8em"}>Low to High</Text>
                                  </Radio>
                                </Stack>
                              </RadioGroup>
                            </Box>
                            <Box>
                              <Checkbox
                                ...
                                onChange={handleDiscountChanges}
                              >
                                <Text fontSize={".8em"}>Discount 5% - 10%</Text>
                              </Checkbox>
                            </Box>
                            <Box>
                              <Checkbox
              ...
              <Container maxW={"100%"}>
                <Box ml={5}>
                  ...
                  {isLargerThan1024 ? (
                    <Box mt="5">
                      <Image
                        src="https://onemg.gumlet.io/c0a6a2ef-7fa4-4d42-b7df-fb90828aa145_1667474655.jpg?w=1062&h=124&format=auto"
                        alt="banner"
                        width={"100%"}
                      />
                    </Box>
                      ...
                      {isLargerThan1024 ? (
                        <HStack>
                          ...
                          <Select
                            ...
                            onChange={handleDiscountChanges}
                          >
                            <option value="hightolow" bgColor="#FAFAFA">
                              High to Low
                            </option>
                            <option value="lowtohigh">Low to High</option>
                            <option value="discount5%-10%">
                              Discount 5% - 10%
                            </option>
                            <option value="discount20%-50%">
                              Discount 20% - 50%
                            </option>
                          </Select>
                        </HStack>
