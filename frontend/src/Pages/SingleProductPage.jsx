...
const SingleProductPage = () => {
  ...
  useEffect(() => {
    axios
      .get(`https://onemg-sz6i.onrender.com/products?_id=${id}`)
      .then((res) => {
  ...
  const handlePriceOnSelect = (e) => {
    ...
    Pricevalue === "2"
      ? setPrices((price * 0.5 + price).toFixed(2))
      : Pricevalue === "3"
      ? setPrices((price * 0.75 + price).toFixed(2))
              ...
              >
                ...
                <Box width={"100%"}>
                  <Box>
                    <Box>
                      <Text
                        width={"100%"}
                        fontSize={["1.2em", "1.2em", "1.4em", "1.6em", "1.8em"]}
                    ...
                    >
                      ...
                      <HStack>
                        <Text
                          ...
                          color={"#ff6f61"}
                        >
                          {(Math.floor(Math.random() * 10) + 10) * 100} Ratings
                          &
                        </Text>
                        <Text
                          fontSize={".9em"}
                          ...
                          color={"#ff6f61"}
                        >
                          {(Math.floor(Math.random() * 10) + 10) * 20}Reviews
                        </Text>
                      </HStack>
                    </Box>
                    <Box mt="5" pl={["12%", "16%", "0", "0", "0"]}>
                      <HStack>
                        <Image
                          src={
                    ...
                    {isLargerThan969 ? (
                      <Box mt="5">
                        <Box>
                          <Text fontWeight={500}>Pack Size (3)</Text>
                        </Box>
                        <Box mt="5">
                          <HStack>
                            <Box
                            ...
                            >
                              ...
                              <Text
                                ...
                                p="1"
                                onClick={() =>
                                  handlePrice((price * 0.5 + price).toFixed(2))
                                }
                              >
                                ₹ {(price * 0.5 + price).toFixed(2)}
                              </Text>
                            </Box>
                            <Box
                              p="2"
                            ...
                            >
                              ...
                              <Text
                                ...
                                p="1"
                                onClick={() =>
                                  handlePrice((price * 0.75 + price).toFixed(2))
                                }
                              >
                                ₹ {(price * 0.75 + price).toFixed(2)}
                              </Text>
                            </Box>
                            <Box
                              p="2"
                            ...
                            >
                              ...
                              <Text
                                ...
                                p="1"
                                onClick={() =>
                                  handlePrice((price * 0.9 + price).toFixed(2))
                                }
                              >
                                ₹ {(price * 0.9 + price).toFixed(2)}
                              </Text>
                            </Box>
                          </HStack>
                        </Box>
                    ...
                    <Box mt="5">
                      <Text fontWeight={500} pl={["12%", "16%", "0", "0", "0"]}>
                        Product highlights
                      </Text>
                      {/*  */}
                      <Box mt="2" pl={["12%", "16%", "0", "0", "0"]}>
                        <ul>
                          ...
                          <li>
                            {" "}
                            Manufactured using advanced technology and rigorous
                            quality control standards.{" "}
                          </li>
                          <li>
                            {" "}
                            Non-allergenic and free from harmful chemicals or
                            additives.
                          </li>
                          <li>
                            {" "}
                            Good customer reviews and satisfaction ratings.{" "}
                          </li>
                ...
                <Box pl="4%" mt={isLargerThan969 ? "10" : null}>
                  <Box
                    ...
                    borderRadius={"15px"}
                    width={["350px", "400px", "400px", "400px", "400px"]}
                        ...
                        >
                          {cities.map((city) => (
                            <option value={city.city}>
                              <Text fontSize={".8em"}>{city.city}</Text>
                            </option>
                          ))}
                        </Select>
                      </HStack>
                  ...
                  {isLargerThan969 ? (
                    <Box mt="5">
                      <Image
                        src={
                          AdvertisementBanner[Math.floor(Math.random() * 8)]
                            .image
                        }
                        alt="banner"
                        borderRadius={"5px"}
                    ...
                    <Box mt="5" mb="5">
                      ...
                      >
                        <HStack pt="8" pb="8" pl="7" pr="10">
                          ...
                          <Text fontSize={".8em"} pl="2" fontWeight={500}>
                            Amazon Pay: Pay with Amazon Pay on Tata 1mg for Rs.
                            100 and more and earn 1% cashback up to Rs. 500.
              ...
              >
                ...
                >
                  <Text fontWeight={"500"} fontSize={"1.2em"}>
                    ...
                    corporis amet error fugiat odit, aliquid porro nulla
                    exercitationem quisquam voluptatibus dolorum quo sequi, ut
                    quidem labore blanditiis modi quos ullam?
                  </Text>
                  <Text mt="5">
                    <Text as={"span"} fontWeight={"500"}>
                      Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                    </Text>{" "}
                    Quae iure quisquam labore obcaecati necessitatibus incidunt
                    sed iste ullam expedita nisi vitae, doloribus, saepe porro
                    aspernatur molestiae. Repellendus ab quod voluptatum. Lorem
                    ipsum dolor sit amet consectetur, adipisicing elit. Natus
                    quae in architecto quos cumque odio ea iste aspernatur vel
                    ducimus.
                  </Text>
                  <Box>
                    ...
                    <ul>
                      <li style={{ marginTop: "10px" }}>
                        ...
                        elitillo atque! Provident natus, eveniet fugit incidunt
                        repudiandae voluptatibus beatae .{" "}
                      </li>
                      <li style={{ marginTop: "10px" }}>
                        {" "}
                        Lorem ipsum dolor, sit amet consectetur adipisicing
                      ...
                      <li style={{ marginTop: "10px" }}>
                        {" "}
                        Lorem ipsum dolor, sit amet consectetur adipisicing
                        elitProvident natus, eveniet fugit incidunt repudiandae.{" "}
                      </li>
                      <li style={{ marginTop: "10px" }}>
                        {" "}
                        Lorem ipsum dolor, sit amet consectetur adipisicing
                        ...
                        >
                          {SpotlightAds.map((items, index) => (
                            ...
                            >
                              ...
                              <Box>
                                <Text fontSize={".8em"} pt="1" color={"gray"}>
                                  {items.description}
                                </Text>
                              </Box>
                              <Box
                              ...
                              >
                                <Box
                                  ...
                                  width={"50px"}
                                >
                                  <Text fontSize={".85em"}>{items.rating}</Text>
                                  <AiFillStar
                                    style={{
                                      justifyContent: "center",
                                      alignItems: "center",
                ...
                {isLargerThan969 ? (
                  <Box
                    pl="5%"
                    width={["200px", "300px", "400px", "450px", "1300px"]}
                    margin={["auto", "auto", "auto", "auto", "auto"]}
                  >
                    <Box>
                      <Box
                      ...
                      >
                        <VStack>
                          <Image
                            src={
                              "https://1mgstaticfiles.s3.amazonaws.com/skuicons/labs.png"
                            }
                            alt="banner"
                          />
                          <Box pt="10">
                        ...
                        <VStack>
                          ...
                          <Box pt="10">
                            <Button
                              ...
                              color="#ff6f61"
                            >
                              <Text p="2">CONSULT A DOCTOR ONLINE</Text>
                            </Button>
                          </Box>
                        </VStack>
                      </Box>
